    ...
    return (
        ...
        <div className="extrapage px-5">
                <div className="page-header ">
                    <h1 className="text-center">Terms & Conditions</h1></div>
            <p>
                ...
                other intellectual property rights related to it, still belong to Heita.
            </p>{" "}
            <p>
                Heita is committed to ensuring that the app is as useful and efficient
            ...
            <p>
                The Heita app stores and processes personal data that you have provided
                ...
                features and it could mean that the Heita app won’t work properly or at
                all.
            </p>{" "}
            <div>
                <p>
                ...
                <p>
                    ...
                    <div className="my-3">
                            ...
                            <a
                                className="text-decoration-none text-secondary ps-5 fs-4"
            ...
            <p>
                You should be aware that there are certain things that Heita will not
                ...
                or provided by your mobile network provider, but Heita cannot take
            ...
            <p>
                Along the same lines, Heita cannot always take responsibility for the
                ...
                the Service, Heita cannot accept responsibility.
            </p>{" "}
            <p>
                With respect to Heita’s responsibility for your use of the app, when
                ...
                it available to you. Heita accepts no liability for any loss, direct or
            ...
            <p>
                ...
                updates if you want to keep using the app. Heita does not promise that
            ...
            <p>These terms and conditions are effective as of 2022-04-25</p>{" "}
            <p>
                <strong>Contact Us</strong>
            </p>{" "}
            <p>
                If you have any questions or suggestions about our Terms and Conditions,
                do not hesitate to contact us at support@heita.app.
            </p>
        </div>
    );
};
